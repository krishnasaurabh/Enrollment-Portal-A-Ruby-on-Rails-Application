...
class WaitlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create waitlist" do
    assert_difference('Waitlist.count') do
      post waitlists_url, params: { waitlist: { course_id: @waitlist.course_id, student_id: @waitlist.student_id } }
    end
  ...
  test "should update waitlist" do
    patch waitlist_url(@waitlist), params: { waitlist: { course_id: @waitlist.course_id, student_id: @waitlist.student_id } }
